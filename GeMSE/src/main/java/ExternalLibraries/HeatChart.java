...
public class HeatChart
{
     ...
     * rows.
     *
     * @param zValues the z-values, where each element is a row of z-values in
     * the resultant heat chart.
     */
     ...
     * number of y-values, with each element containing a double array with an
     * equal number of elements that matches the number of x-values. Use this
     ...
     * in which case the object type of each element will be
     * <code>Double</code>.
     *
     ...
     * @deprecated As of release 0.6, replaced by
     * {@link #setCellSize(Dimension)}
     */
    @Deprecated
    ...
    /**
     * Returns the String that will be displayed as a description of the x-axis
     * in any generated charts.
     *
    ...
    /**
     * Returns the String that will be displayed as a description of the y-axis
     * in any generated charts.
     *
     ...
     * Defaults to Color.BLACK.
     *
     * @param axisValuesColour the new colour to be used for the axis bar
     * values.
     */
     ...
     * value of 1.0 will give a <strong>linear</strong> scale, which will spread
     ...
     * <strong>exponential</strong> scale that will produce greater emphasis for
     * the separation between higher values and a value between 0.0 and 1.0 will
     * provide a <strong>logarithmic</strong> scale, with greater separation of
     * low values.
     *
     * @return the scale factor that is being used to map from z-value to
     * colour.
     */
     ...
     * there the file is unable to written to. Reasons for this include a
    ...
    /**
     * Generates and returns a new chart <code>Image</code> configured according
     ...
     * @return A newly generated chart <code>Image</code>. The returned image is
    ...
    /**
     * Generates and returns a new chart <code>Image</code> configured according
     * to this object's currently held settings. By default the image is
     * generated with no transparency.
     *
     * <p>
     * No chart will be generated until this or the related
     * <code>saveToFile(File)</code> method are called. All successive calls
